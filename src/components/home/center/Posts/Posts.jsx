...
const Posts = (props) => {
    ...
    let postItems = props.posts.map( post => (<PostItem avatar={post.avatar} who={post.who} when={post.when} text={post.text} media={post.media} comments={post.comments} shares={post.shares} />));
